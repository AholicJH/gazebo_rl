...
class PavsReachAvoidEnv(RobotBasicEnv):
    ...
    def __init__(self):
        ...
        world_filename = 'empty_obstacle_randomgoal.world'
        gazebo_max_freq = 1
        ...
        self.goal_model_path = os.path.join(pkg_path1, 'scripts/pavs_env/sdf_model/goals.sdf')
        ...
        while True:
            ...
            if min_distance < distance_from_origin <= max_distance:
                ...
                for obs in obstacles:
                    distance_to_obstacle = math.sqrt((x_goal - obs[0])**2 + (y_goal - obs[1])**2)
                    if distance_to_obstacle < min_obstacle_distance:
                        is_valid = False
                        break
